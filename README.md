...
Suggested R packages: tidyverse, sf, readr, here, mapview/leaflet, ggplot2, tmap (the tutorial will indicate exactly what’s needed)
If running locally, install Quarto: <https://quarto.org/docs/get-started/>

```r
# Example package install (only if running locally)
required <- c("tidyverse","sf","readr","here","ggplot2","tmap","leaflet")
